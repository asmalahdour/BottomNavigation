...
import com.example.bottomnavigation.CoffeeItem;
import com.example.bottomnavigation.FavDB;
    ...
    private void readCursorData(CoffeeItem coffeeItem, ViewHolder viewHolder) {
        ...
        try {
            while (cursor.moveToNext()) {
                //String item_fav_status1 = cursor.getString(cursor.getColumnIndex(FavDB.FAVORITE_STATUS));
